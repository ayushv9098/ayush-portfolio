        ...
        >
          ...
          <div className="relative w-64 h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full p-2 bg-gradient-to-br from-primary/10 via-transparent to-accent/10 border border-white/5 shadow-2xl overflow-visible">
            ...
            <motion.div
              ...
              className="absolute bottom-2 -right-4 glass-card px-3 py-1.5 rounded-full border border-white/10 backdrop-blur-xl z-20"
            >
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                <span className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">Online</span>
              </div>
            </motion.div>
          </div>
        </motion.div>
